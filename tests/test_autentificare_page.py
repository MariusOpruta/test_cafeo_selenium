...
def test_login_with_new_data(browser):
    ...
    home_page.load_page()
    home_page.click_contul_meu_button()
    new_data_page.email_creaza_cont("x55787b3.hb123@yahoo.com")
    ...
    sleep(5)
    assert "Bine ai venit în contul tău. Aici poți modifica informațiile personale și vedea detalii referitoare la comenzile tale." in new_data_page.mesage_valid_text()
